# Important Note
This application is not for practical use, it will NOT save your complied lists once you quit. I am a student learning as I go, this personal project is me applying what I have learned in class to gain more practice. I am currently taking a web systems class and hope to implement a client-side dynamic page version of this project that will save lists in a SQL database specific to each logged in user.

# 💡 New implementations TBD
- create a web version to save lists for logged in users 
